...
class TestГлавногоОкна(unittest.TestCase):
    ...
    def testОбновленияЭлементовИПредыдущегоСостоянияПриПереключенииЦикла(self):
        ...
        элемент111 = найтиЭлементПоИмени('Задача-1-1-1')
        self.assertEqual(ОМ.СостояниеЗадачи.можноДелать, элемент111.задача.предыдущееСостояние)
        ...
        self.assertEqual(ОМ.СостояниеЗадачи.нужноДелать, элемент111.задача.предыдущееСостояние)
